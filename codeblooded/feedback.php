...
<html>
	...
	<?php
		if(isset($_POST['submit'])){
    	    ...
    	    insert_feedback($_POST['name'], $_POST['email'], $_POST['phone'], $_POST['website'], $_POST['message']);
			echo '<script type="text/javascript"> alert("Response Submitted");</script>';
		}
	?>
    <body>
        <div class="container">
            <form id="contact" action="#" method="post">
                ...
                <fieldset>
                    <input placeholder="Your Web Site (optional)" type="url" name="website" tabindex="4" required>
                </fieldset>
                <fieldset>
